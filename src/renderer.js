...
const I18N = {
  ru: {
    ...
    freeKeyLead: "Добавьте в друзья Xbox создателя лаунчера и получите бесплатный пробный период на 24 часа.",
    freeKeyOneTime: "Единоразовая акция",
    freeKeyNote: "Акция действует один раз для нового пользователя. После добавления дождитесь подтверждения от создателя.",
    openCreatorXbox: "Открыть Xbox: GoshGame5697",
    understood: "Понятно",
  ...
  en: {
    ...
    buyKey: "Buy key",
    freeKey: "Free key",
    freeKeyLead: "Add the launcher creator as an Xbox friend and receive a free 24-hour trial period.",
    freeKeyOneTime: "One-time offer",
    freeKeyNote: "This offer is available once for a new user. After adding the creator, wait for confirmation.",
    openCreatorXbox: "Open Xbox: GoshGame5697",
    understood: "Got it",
  ...
  kk: {
    ...
    freeKey: "Тегін кілт",
    freeKeyLead: "Лаунчер жасаушысын Xbox-та досқа қосып, 24 сағаттық тегін сынақ мерзімін алыңыз.",
    freeKeyOneTime: "Бір реттік акция",
    freeKeyNote: "Акция жаңа қолданушыға бір рет беріледі. Досқа қосқаннан кейін жасаушының растауын күтіңіз.",
    openCreatorXbox: "Xbox ашу: GoshGame5697",
    understood: "Түсіндім",
  ...
  uk: {
    ...
    exit: "Вийти",
    buyKey: "Купити ключ",
    freeKey: "Безкоштовний ключ",
    freeKeyLead: "Додайте творця лаунчера в друзі Xbox і отримайте безкоштовний пробний період на 24 години.",
    freeKeyOneTime: "Одноразова акція",
    freeKeyNote: "Акція доступна один раз для нового користувача. Після додавання дочекайтеся підтвердження від творця.",
    openCreatorXbox: "Відкрити Xbox: GoshGame5697",
  ...
  tr: {
    ...
    freeKey: "Ücretsiz anahtar",
    freeKeyLead: "Başlatıcı oluşturucusunu Xbox arkadaşlarına ekleyin ve 24 saatlik ücretsiz deneme süresi kazanın.",
    freeKeyOneTime: "Tek seferlik kampanya",
    freeKeyNote: "Kampanya yeni kullanıcı için yalnızca bir kez geçerlidir. Ekledikten sonra oluşturucunun onayını bekleyin.",
    openCreatorXbox: "Xbox aç: GoshGame5697",
    understood: "Anladım",
